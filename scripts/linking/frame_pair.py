class Frame_pair:
    def __init__( self, a_frame_inst, b_frame_inst):
        ...
        self.a_frame_type = a_frame_inst.type
        self.b_frame_type = b_frame_inst.type
        a_bundle_id = a_frame_inst.bundle_id
        b_bundle_id = b_frame_inst.bundle_id
        if a_bundle_id != b_bundle_id:
            raise Exception( "Frame pair across bundles.")
        self.bundle_id = a_bundle_id
        self.a_index = a_frame_inst.index
        self.b_index = b_frame_inst.index
    ...
    def __eq__( self, other):
        ...
        does not account of differences inside particular frames
