...
output_name = "../data/b_conllu/"+test_corp_name+".conllu"
align_file_name = "../data/b_aligned/"+corp_name
out_align_name = "../data/b_aligned/"+test_corp_name
gold_input_name = "../data/test_results/gold_"+corp_name
gold_output_name = "../data/test_results/gold_"+test_corp_name
...
with open( treebank_name, 'r') as input_file, \
    ...
    my_indices = []
    if '1' in sample_id:
        my_indices += [ index for index in list( range( 0, 300)) if index % 3 == 0 ]
    if '2' in sample_id:
        my_indices += [ index for index in list( range( 0, 300)) if index % 3 == 1 ]
    if '3' in sample_id:
        my_indices += [ index for index in list( range( 0, 300)) if index % 3 == 2 ]
