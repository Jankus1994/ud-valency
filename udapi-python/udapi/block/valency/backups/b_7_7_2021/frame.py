...
class Frame_inst_arg:
    ...
    def set_token( self, token):  # void
        """ called from Token.set_arg """
        self.token = token
    def get_token( self):  # -> Token
        """ called from Align_control.print_paired_args """
        return self.token

    #def get_node( self):
    #    """ called from Frame_inst.process_sentence
    #    for setting a pointer from Token
    #    """
    #    return self.node
...
class Frame_inst:
    def __init__( self):
        ...
        self.verb_node = None
        self.verb_node_ord = None
        self.verb_parent_ord = None
        self.verb_parent_upos = None
        self.verb_deprel = None
        self.bundle_id = None
        self.index = None  # order of the frame_inst in its sentence
    ...
    def set_verb_node_ord( self, verb_node_ord):  # void
        """ called from Frame_extractor._process_sentence """
        self.verb_node_ord = verb_node_ord
    def set_verb_parent_ord( self, verb_parent_ord):  # void
        """ called from Frame_extractor._process_sentence """
        self.verb_parent_ord = verb_parent_ord
    def set_verb_parent_upos( self, verb_parent_upos):  # void
        """ called from Frame_extractor._process_sentence """
        self.verb_parent_upos = verb_parent_upos
    def set_verb_deprel( self, verb_deprel):  # void
        """ called from Frame_extractor._process_sentence """
        self.verb_deprel = verb_deprel
    ...
    def get_verb_node_ord( self):  # -> int
        """ called from Frame_aligner._frame_alignment """
        return self.verb_node_ord
    def get_verb_parent_ord( self):  # -> int
        """ called from Ud_linker.create_info_triplets """
        return self.verb_parent_ord
    def get_verb_parent_upos( self):  # -> str
        """ called from Ud_linker.create_info_triplets """
        return self.verb_parent_upos
    def get_verb_deprel( self):  # -> str
        """ called from Ud_linker.create_info_triplets """
        return self.verb_deprel
